...
{#if isOpen}
	...
	>
		...
		<div
			class="relative w-full max-w-md rounded-xl border border-[var(--lc-border-soft)] bg-[var(--lc-surface-elevated)] p-6 shadow-xl"
		...
		>
			...
			>
				<div class="flex items-center gap-2">
					...
					<div>
						<h2 class="lc-text-primary text-sm font-bold">
